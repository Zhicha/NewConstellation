  ...
  <header class="headermain">
    ...
    <?php
      ...
      while ($row = $res->fetch_assoc()) {
          ...
          '<input id="counton" class="editonoff" type="checkbox" hidden name="edition" disabled value=""',$row['editon'],'>','</div>' . "\n";
      }
      $mysqli->close();
      ?>
    </div>
    ...
    <ul>
      <li class="activepoint"><a href="count.php">Count</a></li>
      ...
      <li class="notactivepoint"><a href="#">New</a></li>
      <li class="notactivepoint"><a href="#">Edit</a></li>
      <li class="notactivepoint"><a href="#">Delete</a></li>
      <li class="notactivepoint"><a href="#">Накладная >1 позиции</a></li>
      </div>
    </ul>
      </nav>
