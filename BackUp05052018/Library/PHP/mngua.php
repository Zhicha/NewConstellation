...
<html>
  ...
  <header class="headermain">
    ...
    <ul>
      ...
      <li class="notactivepoint"><a href="manager.php">Manager</a></li>
      <li class="activepoint"><a href="mngua.php">Ua <img class="flag" src="img/ukraineflag.png" alt=""></a></li></a></li>
...
<?php
  ...
  $res = $mysqli->query("SELECT `id`, `art`, `country`, `city`, `type`, `name`, `website`, `info`, `email`, `phone`, `manageruniver`, `medical`, `dental`, `pharmacy`, `engineer`, `medicalfee`, `dentalfee`, `pharmacyfee`, `engineerfee`, `teacheng`, `step`, `lastanswer`, `conditions`, `status`, `history` FROM `univesiteis` WHERE `country`='Ukraina'");
